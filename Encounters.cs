   ...
   public class Encounters
    {
       ...
       public static void FirstEncounter()
        {
            Console.WriteLine("You throw open the door and grab a rusty metal sword while charging toward the captor");
        ...
        public static void Combat(bool random, string name, int power, int health)
        {
            ...
            while(h > 0)
            {
                ...
                {
                    //Attack
                    Console.WriteLine("with haste you surge forth, your sword flying in your hands! As you pass, the "+n+" stands there preparing its attack.");
                ...
                {
                    //Death Code
                    Console.WriteLine("As the " + n + " stands tall and comes down to strike. You have been killed by the mighty " + n);
                    Console.ReadKey();
